 ...
 * interfészt, decimális számrendszerben.
 * 
...
public class Sudoku9x9 implements Sudoku {
	 ...
	 * Az osztály loggere.
	 */
	private static Logger logger = LoggerFactory.getLogger(Sudoku9x9.class);

	/**
	 * A sudoku tábla reprezentáló tömbje.
	 */
	private int[][] tabla = new int[9][9];

	/**
	 * A sudoku tábla mezőinek módosíthatóságát reprezentáló tömbje.
	 */
	private boolean[][] modosithato = new boolean[9][9];
	...
	public Set<Koordinatak> negyzetKipirosit(int sor, int oszlop) {
		...
		logger.debug(
				...
				kezdoSor + 1, kezdoOszlop + 1, kezdoSor + 3, kezdoOszlop + 3);
		return e;
	}
	 ...
	 * 
	 * @param modosithato az uj logikai módosíthatósági érték
	 * @param sor az adott sor indexe
	 * @param oszlop az adott oszlop indexe
	 */
